...
api.get("/vendors/put/:vendorId", async (c) => Vendors.put(c));
...
api.get("/vendors/delete/:vendorId", async (c) => Vendors.delete(c));
...
api.get("/cartridges/put/:vendorId/:cartridgeId", async (c) => Cartridges.put(c));
...
api.get("/cartridges/delete/:vendorId/:cartridgeId", async (c) => Cartridges.delete(c));
